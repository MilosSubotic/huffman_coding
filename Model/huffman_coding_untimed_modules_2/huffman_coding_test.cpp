...
private:
    void channel_enc_data() {
    	while(true){
    		...
    		algo_log << "e = 0x" << hex << setw(8) << e << dec
    				<< (last ? " last" : "")<< endl;
...
int sc_main(int, char**) {
	...
	algo_log << "in_last: " << in_last << endl;
	algo_log << "out_last: " << out_last << endl;

	algo_log << "in_data size: " << in_data.size() << endl;
	algo_log << "enc_data size: " << enc_data.size() << endl;
	algo_log << "out_data size: " << out_data.size() << endl;

	algo_log << "Comparing input and output..." << endl;
	if(in_data != out_data){
	...
	algo_log << "Comparing input and output last..." << endl;
	if(in_data != out_data){
		algo_log << endl << "Mismatch!!!" << endl;
		cerr << endl << "Mismatch!!!" << endl;
		return 1;
